						...
						if (datas === "Expired") Pages.list.video(id);
							...
							videoElement.addEventListener("timeupdate", () => {
								...
								if (videoElement.seekable.length > 0) {
									...
									loadedTimeline.style.width = `${videoElement.seekable.end(videoElement.seekable.length - 1) - videoElement.seekable.start(videoElement.seekable.length - 1) / videoElement.duration * 100}%`;
								} else {
							...
							controls.append(loader, statusButton, settingsButton, settingsWindow, downloadButton, downloadWindow, timeline);
